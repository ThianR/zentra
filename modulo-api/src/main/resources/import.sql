...
INSERT INTO empresas (id, ruc, razon_social, dv, cod_establecimiento, punto_expedicion, direccion, numero_casa, cod_departamento, departamento, cod_distrito, distrito, cod_ciudad, ciudad, telefono, email, actividad_economica, tipo_contribuyente, ruta_certificado, password_certificado, ambiente, id_csc) VALUES ('8394835', '8394835', 'JORGE APARECIDO DE SANT''ANNA', '0', '001', '001', 'Avda Mariscal Lopez 1234', '1234', 1, 'CAPITAL', 1, 'ASUNCION', 1, 'ASUNCION', '021000000', 'emisor@zentra.com.py', 'SERVICIOS TECNOLOGICOS', 2, 'd:/Personales/SISTEMAS/SIFEN/zentra/context/cert/JORGE_APARECIDO_DE_SANT_ANNA_CODE_S_A.p12', 'neguinha1', 2, '0001');
